...
async def paper_relevance_search(
    ...
    try:
        ...
        track_papers(result, "paper_relevance_search")
        return result
...
async def paper_bulk_search(
    ...
    try:
        ...
        track_papers(result, "paper_bulk_search")
        return result
    except S2ValidationError as exc:
        return s2_exception_to_error_response(exc)
    except S2Error as exc:
...
async def paper_title_search(
    ...
    try:
        ...
        result = await _client().match_paper_title(request)
        track_papers(result, "paper_title_search")
        return result
    except S2ValidationError as exc:
        return s2_exception_to_error_response(exc)
...
async def paper_details(
    ...
    try:
        ...
        result = await _client().get_paper(request)
        track_papers(result, "paper_details")
        return result
    except S2ValidationError as exc:
        return s2_exception_to_error_response(exc)
    except S2ApiError as exc:
...
async def paper_batch_details(
    ...
    try:
        ...
        result = await _client().batch_papers(request)
        track_papers(result, "paper_batch_details")
        return result
    except S2ValidationError as exc:
        return s2_exception_to_error_response(exc)
    except S2Error as exc:
...
async def snippet_search(
    ...
    try:
        ...
        result = await _client().search_snippets(request)
        track_papers(result, "snippet_search")
        return result
    except S2ValidationError as exc:
        return s2_exception_to_error_response(exc)
    except S2Error as exc:
